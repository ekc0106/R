---
title : "통계자료분석캡스톤디자인_recreation trip data"
author : "2013580019 엄규철"
date : "2018년 11월 7일"
...
```{r}
recreation_trip_dat <-  read.table('file:///C:/Users/kyucheol/Desktop/recreational_trip_data.txt', 
...
datatable(recreation_trip_dat)
# t(as.matrix(table(recreation_trip_dat$V3)))
knitr::kable(sapply(recreation_trip_dat,summary))
```
...
# zip <- zeroinfl(V3 ~ .|1+SO+I, data = recreation_trip_dat, dist = 'poisson') # 논문은 이렇게 모형세웠는데 아무리 봐도 I의 zero part가 너무 유의하지않음.
...
(negbin_table <- table_fun(negbin_mat))
```
...
theta_pos <- exp(xbeta) # Q) link function? logit or log?
